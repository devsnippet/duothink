...
$(document).ready(function () {
    if($('.am-form-submit-bar')){
        $('.am-main').addClass('am-mian-form-model');
    }
    //设置表单提交禁用状态
...
function refreshVerify() {
    ...
    document.getElementById('verifyImg').src = '/plugin/helper/verify?time=' + time;
}
...
function clear_cache_log_temp() {
    gform('/plugin/helper/clear_cache_log_temp');
}
/**
 * post提交数据
 * @param url
...
function pform(url, data) {
    $.post(url, data, function (json) {
        showAlert(json.code, json.msg, json.code, json.data);
    })
}
/**
 * get 方式提交数据
...
function gform(url, data) {
    $.get(url, data, function (callback) {
        showAlert(callback.code, callback.msg, callback.code,callback.data);
    })
}
